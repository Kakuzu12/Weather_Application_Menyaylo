...
final class ForecastCell: UICollectionViewCell, SelfConfiguringCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    internal func configure(with item: ForecastTemperature) {
